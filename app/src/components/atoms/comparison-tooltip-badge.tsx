...
export function ComparisonTooltipBadge() {
  return (
    // .comparison-tooltip
    <TooltipPrimitive.Provider delayDuration={200}>
      <TooltipPrimitive.Root>
        ...
        <TooltipPrimitive.Trigger asChild>
          <button
            type="button"
            className="group z-[100] m-0 flex cursor-pointer items-center justify-center self-center border-none bg-transparent p-0 text-[var(--solid-400)] outline-none transition-colors duration-200"
          >
            {/* .comparison-badge */}
            <div className="flex select-none items-center rounded-[8px] shadow-[0_0_0_1px_var(--solid-50)] transition-colors duration-200">
              {/* .comparison-badge-icon: border-r solid-50, 36x36, flex center */}
              <div className="flex size-9 items-center justify-center border-r border-[var(--solid-50)] transition-colors duration-200 group-hover:text-[#EBBE7A]">
                <CrownIcon />
              </div>
              {/* .comparison-badge-label: flex-1, py-1.5 px-3 */}
              <div className="flex-1 px-3 py-1.5">
                <div className="text-[var(--solid-600)]">
                  <div className={siteText.labelM}>Only with Foreplay</div>
                </div>
              </div>
            </div>
          </button>
