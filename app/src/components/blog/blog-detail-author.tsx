...
import { BlogAuthorSocialIcon } from "@/components/blog/blog-author-social-icon"
    ...
    <div className={cn("flex flex-wrap items-center gap-4 py-6", className)}>
      ...
      <div className="flex-1">
        ...
        <div className="flex flex-col items-start gap-1">
          ...
          <div className="text-[var(--alpha-25,#ffffffeb)]">
            <div className={siteText.labelM}>{author.name}</div>
          </div>
          {author.title && (
            // .text-alpha-200 > .text-body-s
            <div className="text-[var(--alpha-200,#ffffff70)]">
              <div className={siteText.bodyS}>{author.title}</div>
            </div>
          )}
        </div>
      </div>
