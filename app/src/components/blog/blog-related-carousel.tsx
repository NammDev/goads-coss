          ...
          <div className="mx-auto w-full max-w-[832px] px-6 md:px-8 lg:px-10">
            <div className="flex flex-col gap-2">
              <div className="text-foreground">
                <h2 className={siteText.headingL}>Related Articles</h2>
              </div>
              <div className="text-[var(--alpha-100,#ffffffad)]">
                <p className={siteText.bodyM}>
                      ...
                      >
                        ...
                        <div className="flex flex-1 flex-col gap-4 px-6 pb-6 pt-8 max-sm:px-5 max-sm:pb-4 max-sm:pt-5">
                          ...
                          <div className="flex items-center gap-3">
                            ...
                            <div className="text-foreground">
                              <div className={siteText.labelS}>{post.author.name}</div>
                            </div>
                          </div>
                          ...
                          <div className="flex flex-col items-start gap-2">
                            ...
                            <div className="text-foreground">
                              <div className={siteText.labelL}>{post.title}</div>
                            </div>
