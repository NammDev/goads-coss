...
export function BlogPagination({
  ...
  // Inner text gets px-1.5 (matches .button-text-block pattern in CtaButton)
  const buttonClass = cn(
    ...
    "hover:bg-border active:bg-[var(--alpha-100)]",
    ...
    >
      ...
      <div className="flex items-center">
        <div
          ...
          role="heading"
          aria-level={2}
          className={cn(siteText.labelM, "w-full text-center text-foreground")}
        >
