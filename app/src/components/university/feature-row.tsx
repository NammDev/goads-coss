...
export function UniversityFeatureRow({
  icon,
  iconAlt,
  title,
  description,
    ...
    <div className="flex flex-col items-start justify-center gap-8">
      ...
      <div className="flex w-full max-w-[440px] flex-col items-start gap-3 text-left">
        ...
        <div className="max-w-[440px] [text-wrap:pretty]">
          {/* .text-alpha-100: color var(--alpha-100), flex:1 (hidden Webflow prop) */}
          <div className="flex-1 text-[var(--alpha-100)]">
            <p className={cn(siteText.bodyL, "whitespace-pre-line")}>{description}</p>
          </div>
        </div>
      </div>
