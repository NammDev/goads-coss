...
const socialLinks = [
  { label: "linkedin", href: CONTACT.linkedin, icon: <svg width="28" height="28" viewBox="0 0 28 28" fill="none"><path d="M19.28 19.283h-2.221v-3.482c0-.83-.017-1.898-1.157-1.898-1.158 0-1.335.905-1.335 1.838v3.542h-2.222V12.125h2.134v1.006h.029c.298-.563 1.023-1.156 2.106-1.156 2.251 0 2.667 1.481 2.667 3.41v3.898ZM9.836 11.146a1.29 1.29 0 1 1 0-2.58 1.29 1.29 0 0 1 0 2.58Zm1.114 8.137H8.723V12.125H10.95v7.158ZM20.391 6.5H7.608A1.1 1.1 0 0 0 6.5 7.58v12.84c0 .597.495 1.08 1.108 1.08h12.782c.612 0 1.111-.483 1.111-1.08V7.58c0-.597-.499-1.08-1.111-1.08Z" fill="white"/></svg> },
