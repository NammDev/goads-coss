    ...
    <HeaderDropdownBase label="Tools">
      ...
      <div className="w-full overflow-hidden rounded-[28px] border border-[var(--border-nav)] bg-background">
        ...
        <div className="grid grid-cols-12 grid-rows-[auto_auto]">
          ...
          <a
            href="/tools"
            className="group col-span-3 row-span-2 row-start-1 relative m-2.5 flex w-full max-w-[275px] flex-col items-center justify-end justify-self-end overflow-hidden rounded-[18px] border-l border-[var(--border-nav)] bg-background pt-6 pb-7 no-underline transition-all duration-200 hover:opacity-95"
          >
            {/* 3D toolbox image — fills card, behind content */}
            {/* eslint-disable-next-line @next/next/no-img-element */}
            <img
              src="/assets/tools-toolbox.webp"
              alt=""
              aria-hidden="true"
            ...
            <div className="relative z-[2] flex items-center gap-1 text-foreground">
              <div className={siteText.labelS}>Browse all tools</div>
