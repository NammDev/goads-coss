    ...
    <div className="grid auto-cols-fr grid-cols-5 gap-4 max-md:grid-cols-3 max-md:gap-y-8 max-sm:grid-cols-2">
      ...
      <div className="flex items-center [grid-area:span_1/span_5/span_1/span_5]">
        ...
        <div className="flex gap-2">
          {/* ChatGPT */}
          <a href="#" className="flex size-[35px] items-center justify-center rounded-[9px] border-[1.5px] border-[var(--fp-neutral-600)] text-muted-foreground transition-all duration-200 hover:border-[#4da68433] hover:bg-[#4da6841a] hover:text-[#4da684]">
          ...
          {/* Grok */}
          <a href="#" className="flex size-[35px] items-center justify-center rounded-[9px] border-[1.5px] border-[var(--fp-neutral-600)] text-muted-foreground transition-all duration-200 hover:border-[#fff3] hover:bg-[#ffffff1a] hover:text-white">
          ...
          {/* Claude */}
          <a href="#" className="flex size-[35px] items-center justify-center rounded-[9px] border-[1.5px] border-[var(--fp-neutral-600)] text-muted-foreground transition-all duration-200 hover:border-[#d9775733] hover:bg-[#d977571a] hover:text-[#d97757]">
          ...
          {/* Perplexity */}
          <a href="#" className="flex size-[35px] items-center justify-center rounded-[9px] border-[1.5px] border-[var(--fp-neutral-600)] text-muted-foreground transition-all duration-200 hover:border-[#58b5ca33] hover:bg-[#58b5ca33] hover:text-[#58b5ca]">
          ...
          {/* Gemini */}
          <a href="#" className="flex size-[35px] items-center justify-center rounded-[9px] border-[1.5px] border-[var(--fp-neutral-600)] text-muted-foreground transition-all duration-200 hover:border-[#306df633] hover:bg-[#306df61a] hover:text-[#306df6]">
