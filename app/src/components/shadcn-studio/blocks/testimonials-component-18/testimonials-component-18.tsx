...
const TestimonialsComponent = ({ testimonials }: TestimonialsComponentProps) => {
  return (
    <section className='py-8 sm:py-16 lg:py-24'>
      <Carousel
        className='mx-auto grid max-w-[1416px] grid-cols-1 items-center gap-11 px-4 md:grid-cols-2 lg:px-6'
        opts={{
          align: 'start',
          slidesToScroll: 1
        }}
        ...
        <div className='space-y-4 md:space-y-16'>
          <div className='space-y-4'>
            ...
            <p className='text-muted-foreground text-xl'>
              From scaling ad spend to eliminating account bans, here&apos;s how GoAds helped.
            </p>
          </div>
