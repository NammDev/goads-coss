  ...
  return (
    <>
      <div className='mb-8 space-y-4 text-center md:mb-10 lg:mb-18'>
        <h2 className='text-2xl font-semibold tracking-tight md:text-3xl lg:text-4xl'>Our Journey</h2>
        <p className='text-muted-foreground text-xl'>
          Key moments that shaped GoAds from a small team to a full-stack ad infrastructure platform.
        </p>
      </div>
