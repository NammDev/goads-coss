...
interface ProductPageCtaCardProps {
  title: string
        ...
        <div className="relative z-[1] flex max-w-[66%] flex-col gap-8 max-md:max-w-none">
          ...
          <div className="flex flex-col items-start gap-2 [text-wrap:balance]">
            ...
            <div className="flex-1 text-foreground">
              <h2 className={`${siteText.displayH3} max-sm:text-[1.75rem] max-sm:leading-[2.25rem]`}>{title}</h2>
            </div>
            ...
            <div className="flex-1 text-[var(--alpha-100)]">
              <div className="[text-wrap:balance]">
                <p className={`${siteText.bodyL} max-sm:text-base max-sm:leading-6 whitespace-pre-line`}>{description}</p>
              </div>
            </div>
          </div>
