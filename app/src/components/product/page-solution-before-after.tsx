...
interface ProductPageSolutionProps {
  title: string
  description: string
  before: SolutionCard
  after: SolutionCard
...
export function ProductPageSolution({
  title,
  description,
  before,
  after,
}: ProductPageSolutionProps) {
  return (
    <div className="mx-auto flex max-w-[940px] flex-col items-stretch gap-9 py-20 text-center max-md:max-w-[480px] max-md:gap-8 max-md:py-12">
      ...
      <div className="grid auto-cols-fr grid-cols-2 gap-4 self-stretch max-md:grid-cols-1">
        ...
        <div className="flex h-[466px] w-[462px] flex-col gap-5 overflow-hidden rounded-[20px] p-0 shadow-[inset_0_0_0_1px_var(--solid-50)] max-md:h-auto max-md:w-full">
