  ...
  return (
    <>
      ...
      {/* Section 2: White block placeholder (pricing/catalog rows). Mirrors
          SectionWhiteBlock geometry: p-2 outer + rounded-[36px] body,
          and inner content constrained by SectionContainer (the real
        ...
        <SectionContainer>
          ...
          <div className="grid grid-cols-3 gap-6 max-md:grid-cols-2 max-sm:grid-cols-1">
            {[0, 1, 2, 3, 4, 5].map((i) => (
              <div
                key={i}
                className="flex flex-col overflow-hidden rounded-[20px] border border-[var(--solid-700)] p-0"
              >
                {/* image area (2:1) */}
