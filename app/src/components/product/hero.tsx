...
export function ProductHero({
  ...
  return (
    ...
    // Text-only (no preview): substitute Foreplay's --py-section scale (108/96/80) for the missing preview height.
    <div
      className={
        previewImageSrc
    ...
    >
      ...
      >
        ...
        <div className="flex flex-col items-center gap-7 max-md:relative max-md:gap-6 max-md:pb-6">
          ...
          <h1 className={`text-[var(--alpha-300)] ${siteText.overline}`}>
            {overline}
          </h1>
          ...
          <div className="flex max-w-[900px] flex-col items-center gap-4 max-md:gap-3">
            ...
            <h2
              className={`${siteText.displayH1} [text-wrap:balance] ${SITE_HERO_GRADIENT} max-md:text-[3.25rem] max-md:leading-[3.75rem] max-sm:text-[2.375rem] max-sm:leading-[3rem]`}
            >
              {title}
            </h2>
