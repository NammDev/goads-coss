...
interface ProductPageFaqAccordionProps {
  subtitle?: string
  title: string
  description?: string
  items: FaqItem[]
...
export function ProductPageFaqAccordion({
  subtitle = "FAQ", title, description, items, className,
}: ProductPageFaqAccordionProps) {
