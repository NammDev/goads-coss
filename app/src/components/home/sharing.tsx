      ...
      <div className="flex flex-col gap-10">
        ...
        <div className="flex gap-3 max-fp-lg:flex-col max-fp-lg:gap-8">
            ...
            {tabs.map((tab, i) => (
              <button
                ...
                className={cn(
                  ...
                  activeTab === i
                    ? "bg-[var(--solid-25)]"
                    : "bg-transparent hover:bg-[var(--solid-25)]",
                )}
              >
                <div className="flex size-5 items-center justify-center text-[var(--solid-400)]">
                  {tab.icon}
                </div>
                <div className={cn(siteText.labelS, "text-[var(--solid-700)]")}>
                  {tab.label}
                </div>
              </button>
            ))}
          ...
          <div className="flex-1">
            ...
            <div className="flex w-full flex-col gap-3 rounded-[18px] bg-[var(--solid-25)] p-2">
              ...
              <div className="flex flex-col gap-3 p-2">
                ...
                {/* .text-body-s */}
                <div className={cn(siteText.bodyS, "text-[var(--solid-500)]")}>
                  {tabs[activeTab].body}
                </div>
              </div>
              {/* button-light.button-primary: full width, center content */}
              <CtaButton href="/pricing" variant="light-primary" className="w-full justify-center">
                Get Started
              </CtaButton>
            </div>
          </div>
