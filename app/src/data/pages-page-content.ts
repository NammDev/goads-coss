...
// ProductPageCtaCard renders the icon on desktop (right-anchored, 280px)
...
export const pagesFeatureGrid1 = {
  ...
  cards: [
    { imageSrc: "/pages/all-products/fb%20pages.webp", title: "Facebook Pages", description: "Aged, 1K–10K follower, livestream-ready or monetized, pick the trust score that matches your spend." },
    { imageSrc: "/pages/all-products/fb%20profiles.webp", title: "Facebook Profiles", description: "Aged, ID-verified profiles to pair with your Page. Clean history, ready to run." },
    { imageSrc: "/pages/all-products/Business%20Manager.webp", title: "Business Manager", description: "BM1 to BM2500, all Meta-verified. Add your Page, share assets, scale safely." },
    { imageSrc: "/pages/all-products/Verified%20Badge.webp", title: "Verified Badge", description: "Blue tick for Pages and Instagram. Instant credibility boost on the assets you already run." },
    { imageSrc: "/pages/all-products/Unban%20Service.webp", title: "Unban Service", description: "Page restricted? Ads paused? We recover the asset so you keep the audience." },
    { imageSrc: "/pages/all-products/Free%20Tools.svg", title: "Free Tools", description: "BM Invite, Cookie Login, 2FA Generator. Free utilities for media buyers." },
  ],
}
...
export const pagesFeatureGrid2 = {
  cards: [
    { imageSrc: "/pages/features/Aged%20vs%201K%20vs%2010K%20Pages%20Which%20Should%20You%20Buy.webp", title: "Aged vs 1K vs 10K Pages: Which Should You Buy?", description: "Match Page follower count to your campaign type. A clear breakdown of who buys which tier." },
    { imageSrc: "/pages/features/Livestream%20Ads%20Ready%20Pages%20When%20They%20Pay%20Off.svg", title: "Livestream Ads Ready Pages: When They Pay Off", description: "Break-even math for live shopping and video campaigns. When the livestream tier is worth it." },
    { imageSrc: "/pages/features/Why%20Aged%20Pages%20Survive%20Policy%20Review%203%C3%97%20Better.svg", title: "Why Aged Pages Survive Policy Review 3× Better", description: "The trust-score mechanics behind Page history and why fresh Pages get flagged on day one." },
    { imageSrc: "/pages/features/How%20to%20Assign%20a%20Purchased%20Page%20to%20Your%20BM.webp", title: "How to Assign a Purchased Page to Your BM", description: "Step-by-step workflow to add, share and run ads from a new Page without tripping policy flags." },
    { imageSrc: "/pages/features/Monetized%20Pages%20Unlock%20Reels%20%26%20Stars%20Revenue.svg", title: "Monetized Pages: Unlock Reels & Stars Revenue", description: "What monetization actually requires, and how a pre-qualified 10K Page shortcuts the wait." },
    { imageSrc: "/pages/features/Getting%20the%20Blue%20Tick%20on%20a%2010K%20Follower%20Page.webp", title: "Getting the Blue Tick on a 10K Follower Page", description: "Verification eligibility, documents you need, and timelines for the Meta verified badge." },
  ],
}
