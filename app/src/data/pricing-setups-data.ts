...
export const goadsSetupCards: PricingCardData[] = [
  {
    ...
    features: [
      { iconSrc: "/assets/BM.svg", label: "1x BM3 Verified: Business Manager with 3 ad account slots", available: true },
      { iconSrc: "/assets/PROFILES.svg", label: "2x Premium Profiles: High-trust profiles ready for advertising", available: true },
      { iconSrc: "/assets/PAGES.svg", label: "1x Aged Reinstated Page: Established page for campaign stability", available: true },
  ...
  },
  {
    ...
    ctaVariant: "primary",
    features: [
      { iconSrc: "/assets/BM.svg", label: "1x BM5 Verified: $250 spending limit", available: true },
      { iconSrc: "/assets/BM.svg", label: "1x BM3 Verified: Business Manager with 3 ad account slots", available: true },
      { iconSrc: "/assets/PROFILES.svg", label: "4x Premium Profiles: High-trust profiles ready for advertising", available: true },
      { iconSrc: "/assets/PAGES.svg", label: "3x Aged Reinstated Pages: Established pages for campaign stability", available: true },
      { label: "14-Day Warranty: Replacement for profile issues", available: true },
    ],
  },
  {
    ...
    ctaVariant: "secondary",
    features: [
      { iconSrc: "/assets/BM.svg", label: "2x BM5 Verified: $250 spending limit each", available: true },
      { iconSrc: "/assets/PROFILES.svg", label: "6x Premium Profiles: High-trust profiles ready for advertising", available: true },
      { iconSrc: "/assets/PAGES.svg", label: "3x Aged Reinstated Pages: Established pages for campaign stability", available: true },
      { iconSrc: "/assets/PAGES.svg", label: "1x 10,000 Followers Page: Aged reinstated page with established audience", available: true },
      { label: "14-Day Warranty: Replacement for profile issues", available: true },
    ],
  },
]
