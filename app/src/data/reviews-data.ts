...
export const goadsReviews: ReviewData[] = [
  ...
  },
  {
    ...
    rating: 5,
    content: "I own an agency, switched to GoAds from using Atria before. It's infinitely better. Love this app and the extension is incredible.",
    date: "Apr 5, 2026",
    platform: "chrome_web_store",
  },
  {
    name: "Rachel Simmons",
    rating: 5,
    content: "GoAds has been an absolute game changer in getting all my ad inspiration in one place. The ability to create different boards is so useful and easy to come back to for creative testing!",
    date: "Apr 3, 2026",
    platform: "chrome_web_store",
  },
  {
  ...
  },
  {
    name: "Megan Torres",
    rating: 5,
    content: "I have used GoAds before and we are actively using it on a daily basis for creative inspiration and find new angles/hooks for our brands.",
    date: "Mar 25, 2026",
    platform: "chrome_web_store",
  },
  {
