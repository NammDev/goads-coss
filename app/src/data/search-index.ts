...
const PAGES: SearchItem[] = [
  ...
  { id: "p-sales", title: "Talk to Sales", description: "Contact our sales team", href: CONTACT.telegram.sales, category: "pages", icon: MessageSquare, keywords: "contact sales support telegram" },
]
