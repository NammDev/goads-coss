...
import { SolutionTestimonialCard } from "@/components/solution/testimonial-card"
import {
  aboutusHero,
  aboutusTestimonialsSection,
  aboutusTestimonials,
} from "@/data/aboutus-page-data"
      ...
      <UniversityHero
        ...
        title={
          <>
            ...
            <br />
            <span className="text-[var(--alpha-100)]">Advertising Success</span>
          </>
        }
      >
        <div className="flex flex-col items-center gap-8 pt-3 pb-10 max-md:gap-6 max-md:pb-6">
          ...
          <CtaButton href="#testimonials" variant="hero">
            Learn More
          </CtaButton>
        </div>
      </UniversityHero>
          ...
          <SectionContainer>
            ...
            <div className="flex flex-col gap-16 pt-12 max-md:pt-10">
              {aboutusTestimonials.map((t, i) => (
                <SolutionTestimonialCard key={i} {...t} />
              ))}
            </div>
          </SectionContainer>
        </div>
